...
public class DatabaseInitializer {
    ...
    public void init() throws IOException {
        ...
        Comment comment1 = new Comment("Quería compartir mi experiencia con la pistola que compré hace unos meses. He sido un aficionado a las armas de fuego durante muchos años y he probado diferentes marcas y modelos, pero esta pistola realmente me ha impresionado.", "Juan Pérez");
        Comment comment2 = new Comment("Se la compré a mi capibara y le ha quedado genial. La camiseta es muy bonita y de buena calidad. La talla es la que esperaba y el envío fue rápido. Muy contenta con la compra.", "María López");
        Comment comment3 = new Comment("Era un regalo para mi hijo y le ha encantado. Juega mucho con ella ", "Ana García");
